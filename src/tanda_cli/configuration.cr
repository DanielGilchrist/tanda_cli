...
module TandaCLI
  class Configuration
    ...
    delegate clear_access_token!, current_organisation?, current_organisation!, to: current_environment
    ...
    def overwrite!(site_prefix : String, email : String, access_token : Types::AccessToken)
      ...
      self.access_token.scope = access_token.scope.try(&.split(" ").compact_map(&->Scopes::Scope.parse?(String)))
